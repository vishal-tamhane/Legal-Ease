            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium">Case #2023-45: Motion Granted</p>
                  <p className="text-sm text-muted-foreground">Judge Thomas approved your motion to extend discovery</p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium">Case #2023-62: Document Filed</p>
                  <p className="text-sm text-muted-foreground">Opposition filed response to your motion</p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium">Case #2023-78: Hearing Scheduled</p>
                  <p className="text-sm text-muted-foreground">Initial hearing set for June 22, 2023</p>
            ...
            <div className="space-y-4">
              {caseDeadlines.map((deadline, index) => (
                <div key={index} className="bg-secondary/50 dark:bg-justice-800/50 rounded-lg p-4">
                  <p className="text-sm font-medium">Case #{deadline.caseNumber}: {deadline.title}</p>
                  <p className="text-xs text-muted-foreground mt-1">{deadline.deadline}</p>
                  <div className="flex items-center mt-3">
                    <div className="h-6 w-6 rounded-full bg-primary/20 flex items-center justify-center">
                      <Clock className="h-3 w-3 text-primary" />
                    </div>
                    <span className="text-xs text-muted-foreground ml-2">{deadline.type}</span>
                  </div>
                </div>
              ))}
            </div>
